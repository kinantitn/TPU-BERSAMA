    ...
    <form method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card-body row">
            ...
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <p class="text-danger">
                    * Ahli waris harus waga jakarta
                </p>

                <div class="form-group">
                    <label class="form-control-label">Nama</label>
                    <input value="{{ old('name_heir') }}" name="name_heir" class="form-control" type="text" placeholder="Nama" required>
                    @error('name_heir')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('address_heir') }}" name="address_heir" class="form-control" type="text" placeholder="Alamat" required>
                    @error('address_heir')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
                ...
                <div class="form-group">
                    <label class="form-control-label">Hubungan dengan jenazah</label>
                    <input value="{{ old('funeral_relation_heir') }}" name="funeral_relation_heir" class="form-control" type="text" placeholder="Ex: Kakak" required>
                    @error('funeral_relation_heir')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
                    @enderror
            ...
            <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="form-group">
                    <label class="form-control-label">KTP Ahli Waris</label>
                    <input name="identity_heir" class="form-control" type="file" required>
                    @error('identity_heir')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
                ...
                <div class="form-group">
                    <label class="form-control-label">KK Ahli Waris</label>
                    <input name="family_heir" class="form-control" type="file" required>
                    @error('family_heir')
                    <small class="text-danger">
                        {{ $message }}
                    </small>
